    ...
    <div
            ...
            <div class="flex flex-wrap items-center justify-between mx-auto p-4">
                <div class="flex items-center ">
                    ...
                    <a href="{{ route('dashboard') }}" class="flex items-center">
                        ...
                        <span class="text-[1.4rem] font-somibold text-slate-100 font-unbounded ml-1">You Talent</span>
                    </a>
                </div>
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                    <ul
                        ...
                        <li>
                            <a href="#"
                                class="block py-2 px-3 text-white bg-red-700 rounded md:bg-transparent md:text-red-700 md:p-0 md:dark:text-red-600"
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="mt-16">
                            ...
                            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-md rounded-lg">
                                <a href="#">
                                    <img class="w-full h-48 object-cover object-center"
                                        src="https://img.freepik.com/vecteurs-libre/haut-parleur-megaphone-eclairages-rouge_1284-58706.jpg?w=996&t=st=1706868024~exp=1706868624~hmac=a88cb5ba7e16ad9d4d7eb65f0725274d93d0ee00cdcccd98a8301860ce9c006e"
                                        alt="{{ $advert->title }}" />
                                </a>
                                <div class="p-6">
                ...
                <!-- Pagination links -->
                <div class="mt-4 px-3 pb-3 w-full">
                    {{ $adverts->links() }}
                </div>
            </div>
        </div>
