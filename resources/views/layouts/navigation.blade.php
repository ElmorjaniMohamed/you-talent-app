<nav x-data="{ open: false }" class="bg-slate-50 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 fixed w-full z-20">
    ...
    <div class=" mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex items-center ">
                ...
                <span class="text-[1.4rem] font-somibold text-gray-500 dark:text-slate-100  font-unbounded pl-1">You Talent</span>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border-3 bg-transparent hover:bg-blue-500 text-blue-500 hover:text-white border border-blue-500 dark:border-gray-500 text-sm leading-4 font-medium rounded-md dark:text-gray-400 bg-white dark:bg-gray-800 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
