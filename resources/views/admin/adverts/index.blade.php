                                ...
                                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                        ...
                                        <select id="category"
                                            ...
                                            @foreach ($companies as $company)
                                                <option value="{{ $company->id }}"
                                                    @if ($advert->company_id == $company->id) selected @endif>
                                                    {{ $company->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>è
                                    <div class="sm:col-span-2">
                                        ...
                                        <textarea id="description" name="description" rows="4"
                                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="Write advert content here">{{ $advert->content }}</textarea>
                                    </div>
                                </div>
                                <button type="submit"
                                    class="text-white inline-flex items-center bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                ...
                <div id="readProductModal" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-xl max-h-full">
                        ...
                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                            ...
                            <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">{{ $advert->title }} </dd>
                            <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Content</dt>
                            <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400"> {{ $advert->content }}</dd>
                            <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Company</dt>
                            <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400"> {{ $advert->company->name }}</dd>
