                        ...
                        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                            <div
                                ...
                                <div
                                    ...
                                    <button type="button" id="createProductModalButton"
                                        ...
                                        class="flex items-center justify-center text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:ring-blue-700 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-500 dark:hover:bg-blue-600 focus:outline-none dark:focus:ring-blue-700">
                            ...
                            <div class="overflow-x-auto">
                                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    <thead
                                        class="text-xs text-slate-100 uppercase bg-blue-500 dark:bg-gray-700 dark:text-gray-400">
                                        <tr>
                                    ...
                                    <tbody id="advertsTableBody">
                                        @foreach ($companies as $company)
                                            <tr class="border-b dark:border-gray-700">
                                                ...
                                                <td class="px-4 py-3">{{ $company->size }}</td>
                                                <td class="px-4 py-3 max-w-[12rem] truncate">{{ $company->location }}
                                                </td>
                                                <td class="px-4 py-3">{{ $company->created_at }}</td>
                                                <td class="px-4 py-3">{{ $company->updated_at }}</td>
                                                <td class="px-4 py-3 flex items-center justify-end">
                                                    <button id="{{ $company->name }}-dropdown-button"
                                                        data-dropdown-toggle="{{ $company->name }}-dropdown"
                                                    ...
                                                    <div id="{{ $company->name }}-dropdown"
                                                        class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                                        <ul class="py-1 text-sm"
                                                            aria-labelledby="{{ $company->name }}-dropdown-button">
                                                            <li>
                                                                <button type="button"
                                                                    data-modal-target="updateProductModal{{ $company->id }}"
                                                                    data-modal-toggle="updateProductModal{{ $company->id }}"
                                            ...
                                            <!-- Update modal -->
                                            <div id="updateProductModal{{ $company->id }}" tabindex="-1"
                                                aria-hidden="true"
                                                            ...
                                                            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <input type="text" name="location"
                                                                        ...
                                                                        value="{{ isset($company) ? $company->location : '' }}"
                                                                        required="">
                                                                </div>
                        ...
                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                            ...
                            <form action="{{ route('companies.store') }}" method="POST">
                                ...
                                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                    ...
                                    <div class="sm:col-span-2">
                                        <label for="size"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Scale</label>
                                        <select id="size" name="size"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <textarea id="description" name="description" rows="4"
                                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="Write company description here"></textarea>
                                    </div>
                                </div>
                                <button type="submit"
                                    class="text-white inline-flex items-center bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                        ...
                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                            ...
                            <div class="flex justify-between mb-4 rounded-t sm:mb-5">
                                <div class="text-lg text-gray-900 md:text-xl dark:text-white">
                                    <h3 class="font-semibold ">{{ isset($company) ? $company->name : '' }}</h3>
                                </div>
                                <div>
                                    <button type="button"
...
@include('admin.companies.searchCompanies')
