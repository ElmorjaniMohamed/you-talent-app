                                ...
                                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400"
                                    ...
                                    <tbody id="UsersTableBody">
                                        @foreach ($skills as $skill)
                                            <tr class="border-b dark:border-gray-700" id="{{ 'skill_' . $skill->id }}">
                                                <td
                                                    class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                    {{ $skill->name }}
                                                </td>
                                                <td class="px-4 py-3 max-w-[12rem] truncate">{{ $skill->created_at }}
                                                </td>
                                                <td class="px-4 py-3">{{ $skill->updated_at }}</td>
                                                <td class="px-4 py-3 flex items-center justify-end">
                                                    <button id="{{ $skill->id }}-dropdown-button"
                                                        data-dropdown-toggle="{{ $skill->id }}-dropdown"
                                                    ...
                                                    <div id="{{ $skill->id }}-dropdown"
                                                        class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                                        <ul class="py-1 text-sm"
                                                            aria-labelledby="{{ $skill->id }}-dropdown-button">
                                                            <li>
                                                                @can('edit-skill')
