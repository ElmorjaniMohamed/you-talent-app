                                ...
                                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400"
                                    ...
                                    <tbody id="UsersTableBody">
                                        @foreach ($roles as $key => $role)
                                            <tr class="border-b dark:border-gray-700" id="{{ 'role_' . $role->id }}">
                                                <td
                                                    class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                    {{ $role->name }}
                                                </td>
                                                <td class="px-4 py-3 max-w-[12rem] truncate">{{ $role->created_at }}
                                                </td>
                                                <td class="px-4 py-3">{{ $role->updated_at }}</td>
                                                <td class="px-4 py-3 flex items-center justify-end">
                                                    <button id="{{ $role->id }}-dropdown-button"
                                                        data-dropdown-toggle="{{ $role->id }}-dropdown"
                                                    ...
                                                    <div id="{{ $role->id }}-dropdown"
                                                        class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                                        <ul class="py-1 text-sm"
                                                            aria-labelledby="{{ $role->id }}-dropdown-button">
                                                            <li>
                                                                @can('edit-role')
