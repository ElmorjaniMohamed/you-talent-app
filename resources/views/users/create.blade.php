                                    ...
                                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <button id="dropdownSearchButton" data-dropdown-toggle="dropdownSearch"
                                                ...
                                                type="button">Add Role <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true"
                                                    ...
                                                    @foreach ($roles as $role)
                                                        <li>
                                                            <div
                                                                ...
                                                                <input id="checkbox-item" type="checkbox" name="roles[]"
                                                                    value="{{ $role}}"
                                                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                                                <label for="checkbox-item"
                                                                    class="w-full py-2 ms-2 text-sm font-medium text-gray-900 rounded dark:text-gray-300">{{ $role }}</label>
                                                            </div>
                                                        </li>
                                                    @endforeach
                                                </ul>
